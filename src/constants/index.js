...
export const workExperiences = [
    {
        ...
        title: "Laboratório de tecnologias em software.\n" +
            ...
            "- Automatização de coleta dos dados.\n" +
            "Utilizando Python, PostgreSQL e algumas ferramentas como o DBeaver, SQLAlchemy, Pydantic, Insomnia , PySide6.\n" +
            "\n" +
            "- Blog do LTS.\n" +
            "Utilizando o WordPress, Elementor e outras extensões. O Notion me ajuda a manter meus projetos organizados.",
